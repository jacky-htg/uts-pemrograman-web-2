  ...
  <body>
    ...
    <?php require_once('../templates/toast.php');?>
      ...
      <div style="display:flex">
        <a href="./add.php"><button>Tambah Mahasiswa Baru</button></a> &nbsp; &nbsp;
        <div class="search">
      ...
      <table>
        <tr>
          ...
          <th>
            <a class="header" href="./index.php?sort_field=nim&search=<?php echo isset($where['search'])?$where['search'] : '';?>&sort_order=<?php echo $sort['field'] == 'nim' && $sort['order'] == 'asc' ? 'desc' : 'asc';?>">
              NIM 	<?php echo $sort['field'] == 'nim' ? ($sort['order'] == 'asc' ? '&uarr;': '&darr;') : '';?>
            </a>
          </th>
          <th>
          ...
          <th>
            <a class="header" href="./index.php?sort_field=program_studi&search=<?php echo isset($where['search'])?$where['search'] : '';?>&sort_order=<?php echo $sort['field'] == 'program_studi' && $sort['order'] == 'asc' ? 'desc' : 'asc';?>">
              PROGRAM STUDI 	<?php echo $sort['field'] == 'program_studi' ? ($sort['order'] == 'asc' ? '&uarr;': '&darr;') : '';?>
            </a>
          </th>
          <th>Action</th>
        </tr>
          ...
          <tr>
            ...
            <td style="display:flex;">
              ...
              <form action="./delete.php" method="POST">
                ...
                <input type="hidden" name="token" value="<?php echo $_SESSION['deletemhs'];?>"/>
